...
public class MyScheduleDAO {
	...
	public List<MyScheduleVO> getMyScheduleList(String userId, String keyword, String sortType, String filter) {
		...
		try {
			...
			while (rs.next()) {
				list.add(new MyScheduleVO(rs.getString("MY_SCHEDULE_ID"), rs.getString("SCH_TITLE"),
