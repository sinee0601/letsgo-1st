...
public class ActionFactory {
	public static Action getAction(String cmd) {
		...
		case "deleteVisitItem":
			...
			break;
		case "myScheduleShareUI":
			tmp = new MyScheduleShareUIAction();
			break;
		case "addCompanionAction":
			tmp = new AddCompanionAction();
			break;
		case "addVisitItem":
		...
		case "signupUI":
			...
			break;
		case "editCompanionPermission":
			tmp = new EditCompanionPermissionAction();
			break;
		case "signupAction":
		...
		// case "searchMyScheduleTitleAction": //searchMyScheduleTitleAction
